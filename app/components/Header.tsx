...
function useScrollDirection() {
  ...
  React.useEffect(() => {
    const onResize = () => {
      needsTopPaddingFix.current =  window.innerWidth >= 768 && window.innerWidth < 1400;
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="rounded-xl hidden md:block bg-gradient-to-r from-fuchsia-500 to-indigo-500 px-4 py-2 text-sm font-black text-white shadow-sm hover:opacity-95
