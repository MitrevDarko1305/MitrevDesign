...
export default function TailWindTestimonial() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-zink px-6  py-10 sm:pt-20 sm:pb-20 lg:px-8">
      <h2 className="container text-center md:text-left ml-32 font-black text-white text-4xl leading-tight pb-1 md:pb-2">{t('testimonial_title1')} <span className="bg-gradient-to-r from-fuchsia-300/80 to-indigo-300/80 bg-clip-text text-transparent">{t('testimonial_span_title')}</span> {t('testimonial_title2')} </h2>
