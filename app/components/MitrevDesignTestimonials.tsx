...
export default function TailWindTestimonial() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-zink px-6  py-10 sm:pt-20 sm:pb-20 lg:px-8">
      <h2 className="container text-center  font-black text-white text-3xl leading-tight pb-[-15px] md:pb-2">{t('testimonial_title1')} <span className="bg-gradient-to-r from-fuchsia-300/80 to-indigo-300/80 bg-clip-text text-transparent">{t('testimonial_span_title')}</span> {t('testimonial_title2')} </h2>
      <div className="grid mx-auto max-w-6xl gap-x-12 md:gap-y-20 gap-y-12 lg:grid-cols-2  items-stretch">
