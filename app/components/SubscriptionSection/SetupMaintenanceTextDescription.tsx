...
export default function SetupMaintenanceTextDescription() {
  const t = useTranslations('Built_Supported_Page')
  return (
    <> 
    <SmoothScroll/>
