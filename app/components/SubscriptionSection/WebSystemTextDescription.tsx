...
export default function WebSystemTextDescription() {
  const t = useTranslations("Web_System_Page")
  return (
     <>
     <SmoothScroll/>
    ...
    <div className="max-w-7xl md:px-10 px-4 mx-auto">
      ...
      <section className="space-y-4 ">
        <header className="text-center lg:text-left">
          <h1 className="text-3xl font-semibold text-white mb-6">{t('web_header')}</h1>
        </header>
      ...
      <div className=" text-md space-y-1">
        ...
        <ul className="space-y-1 pl-5 text-zinc-400 text-[15px] leading-tight list-none lg:list-disc">
          <li className="">{t("list_item1")}</li>
          <li className="">{t('list_item2')}</li>
          <li className="">{t('list_item3')}</li>
        </ul>

       <p className="text-[15px] text-zinc-400 pt-6"> {t('web_desc3')}</p>
